...
/***/ function(module, exports, __webpack_require__) {
	...
	var albumEvents = __webpack_require__(12);
	var commentEvents = __webpack_require__(36);
	...
	$(function () {
	  ...
	  $("#content").on("click", ".edit-album", function (e) {
	    var where = $(e.target).parent().parent().find('.update-album');
	    where.toggleClass('hide');
	  });
	  $("#content").on("click", ".comment-album", function (e) {
	    var where = $(e.target).parent().parent().find('.create-comment');
	    where.toggleClass('hide');
	  });
...
/***/ function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://stormy-sierra-53534.herokuapp.com/',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onCreateAlbum = function onCreateAlbum(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.createAlbum(data).then(function (response) {
	    store.album = response.album;
	    ui.onPostSuccess(response.album);
	  }).catch(ui.onCreateError);
	};

	var onShowAlbum = function onShowAlbum(event) {
	  event.preventDefault();
	  api.showAlbums().then(ui.showAlbums).catch(ui.onShowError);
	};

	var onShowAlbumComments = function onShowAlbumComments(event) {
	  event.preventDefault();
	  api.showAlbumComments(+$(this).data('id')).then(ui.onShowAlbumComments).catch(ui.onShowError);
	};

	var onDeleteAlbum = function onDeleteAlbum(event) {
	  event.preventDefault();
	  api.destroyAlbum(+$(this).data('id')).then(ui.onDeleteSuccess).catch(ui.onError);
	};

	var onUpdateAlbum = function onUpdateAlbum(event) {
	  event.preventDefault();
	  var info = getFormFields(event.target);
	  api.updateAlbum(+$(this).data('id'), info).then(ui.onUpdateSuccess).catch(ui.onError);
	};
	...
	module.exports = {
	  ...
	  onShowAlbumComments: onShowAlbumComments
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showAlbum = function showAlbum(id) {
	  return $.ajax({
	...
	var showAlbumComments = function showAlbumComments(id) {
	  return $.ajax({
	...
	var destroyAlbum = function destroyAlbum(id) {
	  return $.ajax({
	    url: config.apiOrigin + '/albums/' + id,
	    headers: {
	      Authorization: 'Token token=' + store.user.token
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showAlbumsTemplate = __webpack_require__(15);
	var showCommentsTemplate = __webpack_require__(35);

	var showAlbums = function showAlbums(data) {
	  ...
	  var showAlbumsHtml = showAlbumsTemplate({ albums: data.albums });
	  ...
	  $("#content").on("click", ".del-album", function (e) {
	    e.preventDefault();
	    var albumDescription = $(e.target).parent().parent();
	    albumDescription.fadeOut();
	  });
	  $(".hide-album-comments").hide();
	};

	var onShowAlbumComments = function onShowAlbumComments(data) {

	  var showCommentsHtml = showCommentsTemplate({ comments: data.comments });
	  var current = data.comments[0].album_id;
	  $(".display-comments[data-id='" + current + "']").empty();
	...
	var showAlbum = function showAlbum(data) {};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n\n  <!-- ^ runs code in partial.handlebaRs file each time loop is run -->\n  <!-- Note how this file and partial file are in the same folder -->\n  <!-- ^ works like a console.log, will print this to console -->\n <!-- Developers, why are we using data-id and not just id? -->\n  <!-- <h1 data-id=\""
	    ...
	    + "</small></h1>\n  <div>\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},((stack1 = (depth0 != null ? depth0.book : depth0)) != null ? stack1.description : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.program(4, data, 0),"data":data})) != null ? stack1 : "")
	    + "  </div> -->\n  <div class=\"album-item\">\n    <div class=\"album-info\">\n      <ul class=\"deets\" data-id=\""
	    ...
	    + "<p>\n        <p><small>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.album_name : stack1), depth0))
	    + "</small></p>\n      </ul>\n      <span class=\"label label-success show-album-comments\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Show Comments</span>\n      <span class=\"label label-info hide-album-comments\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Hide Comments</span>\n    </div>\n    <div class=\"fields\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n      <form class='create-comment hide'>\n        <input type=\"text\" name=\"comment[comment]\" placeholder=\"Comment Here\">\n        <input type=\"hidden\" name=\"comment[album_id]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n        <button type=\"submit\" class=\"btn btn-default\">Create Comment</button>\n      </form>\n      <form class='update-album hide' data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n        <div class=\"form-group\">\n          <input type=\"text\" name=\"album[artist_name]\" id=\"artist-name\" placeholder=\"Artist Name\">\n          <input type=\"text\" name=\"album[album_name]\" id=\"album-name\" placeholder=\"Album Name\">\n          <button type=\"submit\" class=\"btn btn-default refresh\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Update Album</button>\n        </div>\n      </form>\n      <div class=\"display-comments\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"></div>\n    </div>\n    <div class=\"album-edits\">\n      <span class=\"label label-primary edit-album\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Edit Album Info</span><span class=\"label label-primary comment-album\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Comment</span><span class=\"label label-danger del-album\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Delete</span>\n    </div>\n  </div>\n";
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.albums : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <!-- ^ runs code in partial.handlebaRs file each time loop is run -->\n  <!-- Note how this file and partial file are in the same folder -->\n  <!-- ^ works like a console.log, will print this to console -->\n <!-- Developers, why are we using data-id and not just id? -->\n\n\n\n      <p>"
	    + container.escapeExpression(container.lambda(((stack1 = blockParams[0][0]) != null ? stack1.comment : stack1), depth0))
	    + "</p>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.comments : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"useData":true,"useBlockParams":true});
